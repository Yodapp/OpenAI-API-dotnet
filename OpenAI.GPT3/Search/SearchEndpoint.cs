...
namespace OpenAI.GPT3.Searches
{
    /// <summary>
    ...
    /// </summary>
    public class SearchEndpoint : ApiEndpointBase, IEqualityComparer<SearchEndpoint>
    {
        /// <summary>
        /// Constructor of the api endpoint.  Rather than instantiating this yourself, access it through an instance of <see cref="OpenAI.GPT3"/> as <see cref="OpenAI.GPT3.Search"/>.
        /// </summary>
        /// <param name="api"></param>
        internal SearchEndpoint(Api api) : base(api)
        {
        }
        ...
        public async Task<Dictionary<string, double>> GetSearchResultsAsync(SearchRequest request)
        {
            ...
            var response = await client.PostAsync($"https://api.openai.com/v1/engines/{_api.UsingEngine.EngineName}/search", stringContent);
        ...
        {
            return obj is SearchEndpoint endpoint &&
                   EqualityComparer<Api>.Default.Equals(_api, endpoint._api);
        }
        ...
        public bool Equals(SearchEndpoint x, SearchEndpoint y)
        {
            return x.Equals(y);
        }

        public int GetHashCode(SearchEndpoint obj)
        {
